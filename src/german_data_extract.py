...
class GermanWordData:
    # Processed word. Doesn't contain noun article, note suffixes (like '(+Dat)').
    # But does contain "sich" in the case of reflexive verbs if it was specified in the original word.
    word: str
    pos_tag: str
